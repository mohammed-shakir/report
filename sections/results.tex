...
\textbf{Tail latency:} At 800\,\ac{rps}, the cache at $r{=}7$ is the clear winner across skews (Figure~\ref{fig:latency-zipf-800} and Figure~\ref{fig:latency-h3res-800-by-zipf}). Typical gains are $\sim$5$\times$ at P50, $\sim$5--6$\times$ at P95 and $\sim$7--11$\times$ at P99 versus baseline (Figures~\ref{fig:latency-speedup-zipf-800}). $r{=}8$ is mixed: worse tails than baseline at low skew (1.1--1.2), but clearly better once skew is higher (1.3--1.4; Figures~\ref{fig:latency-speedup-zipf-800}). $r{=}9$ is not viable at 800\,\ac{rps} (Figure~\ref{fig:achieved-ratio-zipf-800} and Figure~\ref{fig:errors-zipf-800}).
