...
\begin{figure}[p]
  ...
  \begin{subfigure}[t]{0.49\linewidth}
    ...
    \caption{PostGIS CPU offload factor (baseline/\allowbreak cache).}
...
\textbf{Tail latency:} At 800\,\ac{rps}, the cache at $r{=}7$ is the clear winner across skews (Figure~\ref{fig:latency-zipf-800} and Figure~\ref{fig:latency-h3res-800-by-zipf}). Typical gains are $\sim$5$\times$ at P50, $\sim$5--6$\times$ at P95, and $\sim$7--11$\times$ at P99 versus baseline (Figure~\ref{fig:latency-speedup-zipf-800}). $r{=}8$ is mixed: worse tails than baseline at low skew (1.1--1.2), but clearly better once skew is higher (1.3--1.4; Figures~\ref{fig:latency-speedup-zipf-800}). $r{=}9$ is not viable at 800\,\ac{rps} (Figure~\ref{fig:achieved-ratio-zipf-800} and Figure~\ref{fig:errors-zipf-800}).
...
\textbf{Throughput viability:} Baseline reaches $\sim$0.985 of target at 800\,\ac{rps} (Figure~\ref{fig:achieved-ratio-zipf-800}); $r{=}7$ hits the target almost exactly (Figure~\ref{fig:achieved-ratio-zipf-800}); $r{=}8$ approaches target once skew is moderate (Figure~\ref{fig:achieved-ratio-zipf-800} and Figure~\ref{fig:errors-zipf-800}). Under higher offered load (1000\,\ac{rps}, Zipf\_s{=}1.3), the cache keeps P95/P99 markedly lower and improves achieved/target by $\sim$0.9\,pp (Figure~\ref{fig:loadsens-p95-vs-rps}, Figure~\ref{fig:loadsens-p99-vs-rps}, and Figure~\ref{fig:loadsens-achieved-ratio-vs-rps}; Table~\ref{tab:load-sensitivity}).
