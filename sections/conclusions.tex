...
The H3-keyed, per-cell middleware cache proposed here fills this gap by enabling composition across overlapping \ac{bbox}/polygon queries and by pairing \ac{ttl} with Kafka/\ac{cdc}-driven spatial invalidation to invalidate only the affected H3 cells.
