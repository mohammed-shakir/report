...
\subsubsection{Read Workload: Skew/Hotspot Scenarios and Query Shapes}
x

\subsubsection{Update Workload: Change Events for Invalidation Tests}
x

\subsection{Measurements and Data Analysis}
x

\subsubsection{Metrics and Instrumentation}
x

\subsubsection{Result Processing and Variability Reporting}
x
