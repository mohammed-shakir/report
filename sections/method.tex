...
\begin{figure}[p]
  ...
  \includegraphics[
    ...
    height=\figmaxheight,
    keepaspectratio,
    alt={Architecture diagram showing the middleware read path and update or invalidation path between client, middleware, GeoServer, PostGIS, Redis, and Kafka.}
  ]{figures/diagrams/system_architecture.png}
...
\begin{figure}[p]
  ...
  \includegraphics[
    ...
    height=\figmaxheight,
    keepaspectratio,
    alt={Flow diagram of middleware request handling: parse request, map footprint to H3 cells, query Redis, handle hits or misses, compose and deduplicate results, reapply filters, and return the response.}
  ]{figures/diagrams/request_handling.png}
...
\begin{figure}[p]
  ...
  \includegraphics[
    ...
    height=\figmaxheight,
    keepaspectratio,
    alt={Flow diagram of the experimental procedure showing warm-up, steady-state measurement, export of metrics, reset of state, and repetition across configurations.}
  ]{figures/diagrams/experimental_run.png}
...
\begin{figure}[p]
  ...
  \includegraphics[
    ...
    height=\figmaxheight,
    keepaspectratio,
    alt={C4 container diagram of the docker-compose testbed showing the client, middleware, GeoServer, PostGIS, Redis, and Kafka, and the main query and invalidation flows between them.}
  ]{figures/diagrams/c4_diagram.png}
...
\begin{figure}[p]
  ...
  \includegraphics[
    ...
    height=\figmaxheight,
    keepaspectratio,
    alt={Module diagram of the middleware showing the request entrypoint, cache engine, H3 mapping, Redis-backed cell index and feature store, composition pipeline, adaptive decision components, and the Kafka invalidation runner.}
  ]{figures/diagrams/internal_structure.png}
