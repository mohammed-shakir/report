...
\begin{itemize}
  ...
  \item \textbf{State of the Art} surveys prior research on spatial indexing, adaptive caching, and cache consistency for dynamic geodata, and also introduces the theoretical background needed to understand H3 indexing, caching principles, and consistency mechanisms.
